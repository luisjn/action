...
namespace ActionGameplayTags
{
	...
	ACTION_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Dash)
	...
	ACTION_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_MustBeHeld)
	ACTION_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_MustBeHeld_Block)
	...
	ACTION_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_Block)

	ACTION_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Ability_Dash)
	...
	ACTION_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Status_Dashing)
	ACTION_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Player_Status_Blocking)
}
